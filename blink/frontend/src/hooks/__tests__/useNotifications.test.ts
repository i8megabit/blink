...
describe('useNotifications Hook', () => {
  ...
  it('автоматически удаляет уведомления через указанное время', () => {
    const { result } = renderHook(() => useNotifications());
  ...
  it('приостанавливает автоудаление уведомления', () => {
    ...
    // Проверяем, что уведомление не удалилось через время
    act(() => {
      vi.advanceTimersByTime(15000);
    });
  ...
  it('возобновляет автоудаление уведомления', () => {
    ...
    // Проверяем, что уведомление удалится через 10 секунд
    act(() => {
  ...
  it('очищает все timeouts при clearAllNotifications', () => {
    ...
    // Проверяем, что timeouts не сработают
    act(() => {
